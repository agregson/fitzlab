...
3. Paraformaldehyde (PFA) 1% (PFA is poisonous)
   - Created by diluting 20% stock 1:10 into PBS
4. R10, warm
   - Created by adding 10% FCS by volume to RPMI
...
14. Ammonium chloride lysing solution
   - 10x concentrate for 1 liter
      - Ammonium chloride 82.9 g (15 4mmol/L)
      - Potassium bicarbonate 10.0 g (10 mmol/L)
      - EDTA disodium salt 0.37 g (0.1 mmmol/L)
      - Distilled or DI H2O 1 liter
...
1. Filter BALF through 2x2 or 4x4 gauze to remove mucous and other large non-cellular debris such as clots.
   - Place the gauze on top of a 50 mL conical tube, making a small dimple in the center. 
   - Pre-soak the gauze with PBS to minimize loss of the sample. 
   - Carefully pour the entire sample through the gauze filter.
   - Rinse the gauze with PBS to a maximum volume fo 45 mL per 50 mL conical tube. This may aid in recovering cells trapped in the gauze.
...
4. Remove supernatant the supernatant by your prefered method, being careful not to disturb the cell pellet.
   - If more than one collection tube was obtained for the same sample, the cell pellets can be combined into one tube at this time.
...
1. Get each sample into wells on the 96 well plate. Each well will become a flow tube.
   - Place 180 mcL of sample into each well, i.e., the entire sample.
   - Centrifuge plate at 1200 rpm x 2 minutes.
   - flip drip dry
   - Wipe off the top of the plate.
   - Agitate the plate via a quick vortex.
...
3. Wash excess antibody off of the cells.
   - Add 180 mcL of washing solution to each well. 
   - Centrifuge the plate at 1200 rpm x 2 minutes.
   - flip drip dry
   - Wipe off the top of the plate. 
   - Agitate the plate via quick vortex.
...
1.  Fix cells
   - Add 180 mcL Fixation Buffer to each well.
   - mix well with the pipet time. The cells will likely clump together.
   - *Incubate 60 minutes at 4 C*
...
3.  Wash cells in Permeabilization Buffer.
   - Add 180 mcL Permeabilization Buffer to each well.
   - Centrifuge the plate at 1200 rpm x 2 minutes.
   - flip drip dry
   - Wipe off the top of the plate. 
   - Agitate the plate via quick vortex.
...
4.  Add the fluorescent labelled antibodies. 
   - Add Permeabilization Buffer to each well such that total staining volume per well equals 12 mcL.
   - Add intracellular stains for the day. The stains used will vary depending upon the experiment. Examples and volumes are given below.
      - 4 mcL FoxP3-V450
      - 2 mcL Ki67-FITC
